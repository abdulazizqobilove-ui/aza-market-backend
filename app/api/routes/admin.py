...
SEED_SUBCATEGORIES: dict[str, list[dict]] = {
    ...
    "men": [
        ...
        {"name": "Брюки и джинсы", "slug": "men-pants"},
        {"name": "Верхняя одежда", "slug": "men-outerwear"},
        {"name": "Пиджаки и костюмы", "slug": "men-suits"},
        {"name": "Свитеры и толстовки", "slug": "men-sweaters"},
        {"name": "Шорты", "slug": "men-shorts"},
        {"name": "Нижнее бельё и носки", "slug": "men-underwear"},
