    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: c.bg }}>
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 32 }}>
        ...
        <View style={{ paddingHorizontal: 16, paddingTop: 16, gap: 12 }}>
          ...
          <Text style={{ textAlign: "center", fontSize: 11, color: c.textMuted }}>AZA Market · Версия 1.0.0 · Таджикистан</Text>

          <TouchableOpacity
            onPress={handleLogout}
            style={{ backgroundColor: c.card, borderRadius: 16, paddingVertical: 14, alignItems: "center", borderWidth: 1, borderColor: c.border, flexDirection: "row", justifyContent: "center", gap: 8 }}
          >
            <LogOut size={16} color="#f87171" />
            <Text style={{ color: "#f87171", fontWeight: "600" }}>Выйти из аккаунта</Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
    </SafeAreaView>
