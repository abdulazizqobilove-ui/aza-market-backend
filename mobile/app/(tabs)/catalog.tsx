      ...
      <View>
        ...
        <View style={{ marginHorizontal: 12, marginTop: 12, borderRadius: 20, overflow: "hidden" }}>
          {banner ? (
            ...
            <View style={{ backgroundColor: c.iconBg, padding: 20, flexDirection: "row", alignItems: "center", justifyContent: "space-between", minHeight: 100 }}>
              <View style={{ flex: 1 }}>
                <Text style={{ color: c.textMuted, fontSize: 10, fontWeight: "700", letterSpacing: 0.5, marginBottom: 6 }}>AZA MARKET</Text>
                <Text style={{ color: c.text, fontSize: 18, fontWeight: "800" }}>{active.label}</Text>
                <Text style={{ color: c.textMuted, fontSize: 12, marginTop: 4 }}>Лучшие товары по лучшим ценам</Text>
              </View>
      ...
      <SafeAreaView style={{ flex: 1, backgroundColor: c.bg }}>
        <View style={{ backgroundColor: c.card, paddingHorizontal: 16, paddingTop: 8, paddingBottom: 10, borderBottomWidth: 1, borderBottomColor: c.border }}>
          <View style={{ flexDirection: "row", alignItems: "center", gap: 12, marginBottom: 10 }}>
            ...
            <Text style={{ fontSize: 16, fontWeight: "800", color: c.text, flex: 1 }} numberOfLines={1}>{active.label}</Text>
          </View>
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: c.bg }}>
      <View style={{ backgroundColor: c.card, paddingHorizontal: 16, paddingTop: 8, paddingBottom: 12, borderBottomWidth: 1, borderBottomColor: c.border }}>
        <Text style={{ fontSize: 20, fontWeight: "700", color: c.text, marginBottom: 12 }}>Каталог</Text>
        <TouchableOpacity onPress={() => router.push("/search" as any)} activeOpacity={0.7} style={{ flexDirection: "row", alignItems: "center", backgroundColor: c.iconBg, borderRadius: 20, paddingHorizontal: 16, gap: 8 }}>
          <Search size={16} color={c.textMuted} />
          <Text style={{ flex: 1, paddingVertical: 12, fontSize: 14, color: c.textMuted }}>Найти товар...</Text>
        </TouchableOpacity>
      </View>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 32 }}>
        ...
        <View style={{ paddingTop: 16, paddingBottom: 4 }}>
          <Text style={{ paddingHorizontal: 16, fontSize: 13, fontWeight: "700", color: c.textMuted, marginBottom: 10, letterSpacing: 0.3 }}>
            ПОДБОРКИ
          </Text>
        ...
        <View style={{ paddingHorizontal: 16, marginTop: 20 }}>
          <Text style={{ fontSize: 13, fontWeight: "700", color: c.textMuted, marginBottom: 12, letterSpacing: 0.3 }}>
            ВСЕ КАТЕГОРИИ
          </Text>
          <View style={{ flexDirection: "row", flexWrap: "wrap", gap: 8 }}>
            {CATS.map((cat) => (
              ...
              >
                ...
                <Text
                  style={{ fontSize: 10, fontWeight: "600", color: c.textSub, textAlign: "center", lineHeight: 13 }}
                  numberOfLines={2}
                >
                  {cat.label}
                </Text>
