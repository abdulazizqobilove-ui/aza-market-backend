...
export function SkeletonBox({ width, height, borderRadius = 8, style }: {
  ...
  return (
    <Animated.View
      style={[{ width, height, borderRadius, backgroundColor: c.placeholder, opacity }, style]}
    />
  );
}
...
export function SkeletonCard() {
  const c = useThemeColors();
  return (
    <View style={{ backgroundColor: c.card, borderRadius: 16, padding: 10, gap: 8, width: 160 }}>
